...
async def support_callback(callback_query: types.CallbackQuery):
    await bot.send_message(callback_query.from_user.id, "Якщо у вас виникли питання або ви хочете залишити відгук — напишіть нам: @your_support_username")
